...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
    ...
    *transformatiomationMatrixDate = worldViewProjectionMatrix;
    ...
    {
        instancingData[index].WVP = Makeidetity4x4();
        instancingData[index].World = Makeidetity4x4();
    }
    ...
    D3D12_CPU_DESCRIPTOR_HANDLE instancingSrvHundleCPU = GetCPUDescriptorHandle(srvDescriptorHeap, descriptorSizeSRV, 3);
    D3D12_GPU_DESCRIPTOR_HANDLE instancingSrvHundleGPU = GetGPUDescriptorHandle(srvDescriptorHeap, descriptorSizeSRV, 3);
    device->CreateShaderResourceView(instancingResourse.Get(), &instancingSrvDesc, instancingSrvHundleCPU);
    ...
    while (msg.message != WM_QUIT) {
        ...
        if (PeekMessage(&msg, nullptr, 0, 0, PM_REMOVE)) {
          ...
          //  D3D12_CPU_DESCRIPTOR_HANDLE dsvHandle = dsvDescriptorHeap->GetCPUDescriptorHandleForHeapStart();
            ...
            commandList->SetGraphicsRootDescriptorTable(1,instancingSrvHundleGPU);
            // 追加: 平行光源CBVをバインド
